...
module.exports = async ({ getNamedAccounts, deployments }) => {
  ...
  await balloons.transfer("0x87A0761A13fb0040EcB454753B792205dC9C5a45",""+(100*10**18));
  ...
  await dex.init(""+(0.01*10**18),{value:ethers.utils.parseEther('0.01'),gasLimit:200000})
};
